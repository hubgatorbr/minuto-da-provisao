...
import { getLandingRevealDelay, LANDING_LOGIN_ROUTE } from "@shared/landing";
import {
  ArrowRight,
  BookOpen,
  Briefcase,
...
const PUBLISHED_APP_LOGIN_URL = getAppUrl(LANDING_LOGIN_ROUTE);
      ...
      <header className="landing-header">
        <div className="landing-container landing-header__inner">
          ...
          <div className="landing-header__actions">
            ...
            <a className="landing-login" href={PUBLISHED_APP_LOGIN_URL}>Entrar</a>
            <a className="landing-button landing-button--small" href={PUBLISHED_APP_LOGIN_URL}>COMEÇAR AGORA <ArrowRight /></a>
        ...
        {mobileMenu && <nav className="landing-mobile-nav" aria-label="Navegação mobile">{navItems.map(item => <a key={item.href} href={item.href} onClick={closeMenu}>{item.label}</a>)}<a href={PUBLISHED_APP_LOGIN_URL}>COMEÇAR AGORA <ArrowRight /></a></nav>}
      </header>
      ...
      <main id="conteudo">
          ...
          <div className="landing-container landing-hero__grid">
            <div className="landing-hero__copy landing-reveal">
              ...
              <div className="landing-hero__actions">
                <a className="landing-button landing-button--hero" href={PUBLISHED_APP_LOGIN_URL}>COMEÇAR AGORA <ArrowRight /></a>
        ...
        <section id="jornada" className="journey-section landing-section">
          <div className="landing-container journey-section__grid">
            <div className="journey-copy"><p className="landing-eyebrow"><span /> CONSTÂNCIA COM PROPÓSITO</p><h2>365 dias.<br /><em>Uma jornada.</em></h2><p>Um dia de cada vez. Uma reflexão de cada vez. Uma decisão de cada vez.</p><div className="journey-stats"><div><strong>47 <span>/ 365</span></strong><small>dias concluídos</small></div><div><strong>12</strong><small><Flame /> dias consecutivos</small></div></div><a className="landing-button landing-button--outline" href={PUBLISHED_APP_LOGIN_URL}>COMEÇAR MINHA JORNADA <ArrowRight /></a></div>
        ...
        <section id="experiencia" className="experience-section landing-section">
          <div className="landing-container">
            ...
            <div className="experience-cta"><p>Uma experiência simples o bastante para caber no seu dia.<br />Profunda o bastante para transformá-lo.</p><a className="landing-button landing-button--gold" href={PUBLISHED_APP_LOGIN_URL}>CONHECER A EXPERIÊNCIA <ArrowRight /></a></div>
          </div>
        </section>
